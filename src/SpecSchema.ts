...
const typeMap: any = {
    ...
    "Aura": o([
        { json: "authorities", js: "authorities", typ: u(undefined, a("")) },
    ], false),
    "Balances": o([
        { json: "balances", js: "balances", typ: u(undefined, a(a(u(3.14, "")))) },
    ], false),
    "Grandpa": o([
        { json: "authorities", js: "authorities", typ: u(undefined, a(a(u(0, "")))) },
    ], false),
    "Sudo": o([
